...
export default function HomeClient({ trucks }: HomeClientProps) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-10rem)] md:h-[calc(100vh-12rem)] gap-6">
      ...
      <div className="flex-grow grid grid-cols-1 lg:grid-cols-3 gap-6 min-h-0">
        ...
        <div
          ...
          className={cn(
            ...
            isLargeScreen && viewMode === 'list' && 'lg:col-span-1' // This case is for when list view is active, map should be smaller
          )}
        >
        ...
        {((isLargeScreen && viewMode === 'map' && !isListCollapsed) ||
          ...
          <div
            className={cn(
              ...
              isLargeScreen && viewMode === 'list' && 'lg:col-span-2 block' // List takes more space in list view on large screens
            )}
          >
            {showListTitle && (
            ...
            <ScrollArea className={cn("pr-3", showListTitle ? "h-[calc(100%-3.75rem)]" : "h-full")}>
      ...
      {/* Fallback list for small screens when map view is active (this might be redundant now) */}
